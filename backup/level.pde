...
class level {
  ...
  void run() {
    ...
    for (int i = 0; i < turners.size(); i++) {   
      ...
      fill(0);
      arc(turners.get(i).x, turners.get(i).y, turners.get(i).turnerWidth*0.75, turners.get(i).turnerWidth*0.75,-HALF_PI, PI-(turners.get(i).angle-HALF_PI));
      fill(orange);
      ellipse(turners.get(i).x, turners.get(i).y, turners.get(i).turnerWidth*0.5, turners.get(i).turnerWidth*0.5);
    }
