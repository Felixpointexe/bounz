...
class ball {
  ...
  public void run() {
    ...
    for (int i = 0; i < gm.levels.get(gm.lvl-1).enemys.size(); i++) {   

      enemy enemy = gm.levels.get(gm.lvl-1).enemys.get(i);
...
class enemy {
  ...
  public void run() {
    ...
    if (y > height*0.98f - r || y < r + height/10 ) {   //if ball is at buttom screen
      vy *= -1;
